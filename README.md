...
| **ЦБ3:** Производство лекарств доступно для выполнения заказов в любой момент времени (актив: доступность системы) | Резервный робот + ручной режим управления |
...
| Контроллер                     | Недоверенный    | SS                     | Возможны сбои в обработке команд, что может нарушить ЦБ3                        |
| Аутентификация                 | Недоверенный    | SS                     | Уязвимость 2FA может привести к несанкционированному доступу, нарушая ЦБ2       |
| База данных рецептов           | Недоверенный    | MM                     | Уязвимость базы может привести к утечке данных, нарушая ЦБ2                     |
| Робот                          | Недоверенный    | MM                     | Физическая уязвимость может замедлить производство, нарушая ЦБ3                 |
| Датчик состава                 | Недоверенный    | SS                     | Сбой проверки доступности может нарушить ЦБ3                                    |
